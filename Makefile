...
build-test:
	make build-connect
	sed -i '' -e 's/connect.trezor.io/sisyfos.trezor.io\/martin-connect/g' ./build/js/iframe.*.js
	rsync -avz --delete -e ssh ./build/* admin@dev.sldev.cz:~/sisyfos/www/martin-connect
